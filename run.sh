...
--num_epochs 1 \
--split val_seen \
--resume_from_checkpoint /mnt/petrelfs/huangshijia.p/MM/vl_nav_output/baseline3/checkpoint_3.pt
...
--num_epochs 1 \
--split val_seen \
--resume_from_checkpoint /mnt/petrelfs/huangshijia.p/MM/vl_nav_output/baseline3/checkpoint_1.pt
